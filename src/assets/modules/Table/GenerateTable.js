...
const generateCountriesTable = () => {
  ...
  template += `<div class="countries-list__icon_full-screen countries-table__icon_full-screen icon_full-screen"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  template += `<div class="countries-list__icon_full-screen icon_full-screen table-exit-full-screen hide"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="15px" height="15px"
